#!/usr/bin/env python3
"""Hayat Finans (https://www.hayatfinans.com.tr) için RAG amaçlı, Türkçe-only site indirici.
...
"""
SLUG = 'hayatfinans'
CONFIG = {'NAME': 'Hayat Finans', 'BASE': 'https://www.hayatfinans.com.tr', 'ROOT_DOMAIN': 'hayatfinans.com.tr', 'MODE': 'auto', 'SITEMAPS': ['https://www.hayatfinans.com.tr/sitemap.xml'], 'INCLUDE_PREFIXES': [], 'EXTRA_SEEDS': []}
