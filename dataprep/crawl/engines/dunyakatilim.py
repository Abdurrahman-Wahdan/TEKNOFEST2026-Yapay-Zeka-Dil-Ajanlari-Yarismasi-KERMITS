#!/usr/bin/env python3
"""Dünya Katılım (https://dunyakatilim.com.tr) için RAG amaçlı, Türkçe-only site indirici.
...
"""
SLUG = 'dunyakatilim'
CONFIG = {'NAME': 'Dünya Katılım', 'BASE': 'https://dunyakatilim.com.tr', 'ROOT_DOMAIN': 'dunyakatilim.com.tr', 'MODE': 'auto', 'SITEMAPS': ['https://dunyakatilim.com.tr/sitemap.xml'], 'INCLUDE_PREFIXES': [], 'EXTRA_SEEDS': []}
