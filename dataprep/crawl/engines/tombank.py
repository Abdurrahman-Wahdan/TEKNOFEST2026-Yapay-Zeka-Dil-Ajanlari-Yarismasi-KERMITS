#!/usr/bin/env python3
"""TOM Katılım (https://www.tombank.com.tr) için RAG amaçlı, Türkçe-only site indirici.
...
"""
SLUG = 'tombank'
CONFIG = {'NAME': 'TOM Katılım', 'BASE': 'https://www.tombank.com.tr', 'ROOT_DOMAIN': 'tombank.com.tr', 'MODE': 'recursive', 'SITEMAPS': [], 'INCLUDE_PREFIXES': [], 'EXTRA_SEEDS': []}
