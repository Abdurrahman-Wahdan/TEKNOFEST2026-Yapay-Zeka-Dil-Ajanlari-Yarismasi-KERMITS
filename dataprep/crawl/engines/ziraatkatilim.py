#!/usr/bin/env python3
"""Ziraat Katılım (https://www.ziraatkatilim.com.tr) için RAG amaçlı, Türkçe-only site indirici.
...
"""
SLUG = 'ziraatkatilim'
CONFIG = {'NAME': 'Ziraat Katılım', 'BASE': 'https://www.ziraatkatilim.com.tr', 'ROOT_DOMAIN': 'ziraatkatilim.com.tr', 'MODE': 'auto', 'SITEMAPS': ['https://www.ziraatkatilim.com.tr/sitemap.xml'], 'INCLUDE_PREFIXES': [], 'EXTRA_SEEDS': []}
